...
def process_live_interruption(profile, test_id, file_obj):
    """Delegate to the new standalone interruption engine."""
    from core.interruption_engine import run_erase_interruption
    return run_erase_interruption(profile, test_id, file_obj)
