      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <window.Card>
            ...
            <div style={{ width: "100%", background: "#1e293b", borderRadius: 9999, height: 16, border: "1px solid #334155", overflow: "hidden", position: "relative" }}><div className={running ? "progress-stripes animate-stripe-slide" : ""} style={{ width: `${!running && (flashOp?.total_progress || 0) >= 99.5 ? 100 : Math.max(0, Math.min(100, flashOp?.total_progress || 0))}%`, height: 16, background: "linear-gradient(90deg, #10b981, #3b82f6)", borderRadius: 9999, transition: "width 0.4s" }} /></div>
          ...
          <window.Card>
            ...
            <div style={{ width: "100%", background: "#1e293b", borderRadius: 9999, height: 10, border: "1px solid #334155", marginBottom: 8, overflow: "hidden", position: "relative" }}><div className="progress-stripes animate-stripe-slide" style={{ width: `${flashOp?.progress || 0}%`, height: 10, background: "linear-gradient(90deg, #3b82f6, #06b6d4)", borderRadius: 9999, transition: "width 0.2s" }} /></div>
          ...
          <window.Card>
             ...
             <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                <div>
                  ...
                  <input value={nvmDid} onChange={e => setNvmDid(e.target.value)} placeholder="F1 90" disabled={nvmReading || nvmWriting} style={{ background: "#0f172a", border: "1px solid #334155", borderRadius: 8, padding: "8px 12px", fontSize: 12, fontFamily: "monospace", color: "#f1f5f9", outline: "none", width: "100%" }} />
                ...
                <div>
                  ...
                  <input value={nvmWriteData} onChange={e => setNvmWriteData(e.target.value)} placeholder="00 0A" disabled={nvmReading || nvmWriting} style={{ background: "#0f172a", border: "1px solid #334155", borderRadius: 8, padding: "8px 12px", fontSize: 12, fontFamily: "monospace", color: "#f1f5f9", outline: "none", width: "100%" }} />
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginTop: 2 }}>
                ...
                <window.Btn onClick={() => { setNvmSaveCycleDec("—"); setNvmSaveCycleHex("—"); setNvmLastRead("—"); setNvmErr(""); setNvmWriteStatus("—"); }} disabled={nvmReading || nvmWriting} color="#334155" style={{ width: "100%" }}>
                  Clear Display
                </window.Btn>
              </div>
            ...
            <window.Card>
             ...
             <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
              ...
              <window.Btn onClick={() => setNvmCounterLog([])} disabled={nvmReading || nvmWriting} color='#334155' style={{ padding: '6px 10px' }}>Clear</window.Btn>
             </div>
